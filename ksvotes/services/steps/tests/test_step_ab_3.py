...
def test_step_ab3_is_complete_false_with_missing_arguments():
    form_payload = {}
...
def test_step_ab3_is_complete_true_with_one_address():
    form_payload = {
        "addr": "707 Vermont St",
        "unit": "Room A",
        "city": "Lawrence",
...
def test_step_ab3_is_complete_false_with_bad_address():
    form_payload = {
        "addr": "123 Fake St",
        "city": "Fake",
        "state": "NA",
...
def test_step_ab3_with_mail_addr():
    form_payload3 = {
        "addr": "707 Vermont St",
        "unit": "Room A",
        "city": "Lawrence",
